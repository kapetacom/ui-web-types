...
export interface ILanguageTargetProvider<T = any>
  extends ProviderBase<LanguageTarget> {
  blockKinds: string[];
...
export interface IBlockTypeProvider<T = BlockDefinition>
  extends ProviderBase<BlockType> {
